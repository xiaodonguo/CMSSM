...
✨**2025-10-9**✨ : An extended version of our conference paper, "Cross-modal State Space Modeling and Terrain-specific Knowledge Distillation for RGB-Thermal Semantic Segmentation", has been submitted to TBD. For the convenience of the review process, more details and codes are provided. 
